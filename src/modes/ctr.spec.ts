...
import { _kuznyechik, _magma, _magma2, _magma_acpkm, PT_KUZNYECHIK, PT_MAGMA } from "./_test_utils.test";

const iv = hexToBytes("1234567890abcef0");
const iv2 = iv.subarray(0,4);
...
describe("[CTR-ACPKM] Kuznyechik", () => {
    test("#1", () => {
        ...
        const mode = ctr(_kuznyechik, iv, true);
...
describe("[CTR-ACPKM] Magma", () => {
    test("#1", () => {
        ...
        const mode = ctr(_magma_acpkm, iv2, true);
