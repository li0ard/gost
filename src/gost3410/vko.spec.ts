...
import { ID_GOSTR3410_2001_TEST_PARAM_SET, ID_GOSTR3410_2012_512_PARAM_SET_A, getPublicKey, kek_34102001, kek_34102012256, kek_34102012512 } from ".";
...
describe("[SIGN] VKO 2012", () => {
    ...
    const pub1 = getPublicKey(ID_GOSTR3410_2012_512_PARAM_SET_A, prv1);
    const pub2 = getPublicKey(ID_GOSTR3410_2012_512_PARAM_SET_A, prv2);
